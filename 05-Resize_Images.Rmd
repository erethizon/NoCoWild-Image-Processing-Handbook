...
With imagemagick installed, open a terminal window and move to the directory with the images you wish to resize (see chapter 4to learn more about how move around the terminal).
