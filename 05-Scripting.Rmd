...
8. Paste the following line of code at the cursor `--path-to-processed-images` followed by a space and then drag the appropriate Raw image folder onto the terminal. **Do not press return after pasting**
