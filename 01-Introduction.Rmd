...
(ref:figure1) Steps involved in preparing images for upload to Zooniverse.

```{r, echo = FALSE, figure1, fig.cap = '(ref:figure1)'}
#add figure 1 and a text reference as its caption
knitr::include_graphics("images/fig1.1.overall_workflow_diagram.jpg") #figure
...
(ref:figure2) File and folder organization for the North Country Wild Project
