...
```{r, echo = FALSE, fig.cap = 'Steps involved in preparing images for upload to Zooniverse'}
...
```{r, echo = FALSE, fig.cap = 'File and folder organization for the North Country Wild Project'}
